function [wedge_result_a, wedge_result_b] = WedgeLoewner(index, start_time, final_time, outer_points, inner_points, total_points, wedge_alpha, const, kappa, drive_alpha)
    ...
    time_sol = linspace(start_time,final_time,total_points);
    delta_t = time_sol(2);
